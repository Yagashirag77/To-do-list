...
public class ProjetDAO {
    ...
    public Optional<Projet> findById(int id) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            if (resultSet.next()) {
                ...
                return Optional.of(projet); //creer une instance Optional<Projet>
            }
    ...
    public List<Projet> findByUtilisateurId(int utilisateurId) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de la recherche des projets de l'utilisateur : " + e.getMessage());
    ...
    public List<Projet> findAll() {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de la récupération de tous les projets : " + e.getMessage());

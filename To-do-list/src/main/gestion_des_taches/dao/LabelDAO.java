...
public class LabelDAO {
    ...
    public Label save(Label label) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de l'enregistrement du label : " + e.getMessage());
    ...
    public boolean update(Label label) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de la mise à jour du label : " + e.getMessage());
    ...
    public boolean delete(int id) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de la suppression du label : " + e.getMessage());

...
public class TacheDAO {
    ...
    public Tache save(Tache tache) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            if (tache.getDateEcheance() != null) {
                statement.setDate(3, Date.valueOf(tache.getDateEcheance()));
            } else {
    ...
    public List<Tache> findByUtilisateurId(int utilisateurId) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de la recherche des tâches de l'utilisateur : " + e.getMessage());
    ...
    public List<Tache> findByProjetId(int projetId) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de la recherche des tâches du projet : " + e.getMessage());
    ...
    public List<Tache> findByCategorieId(int categorieId) {
        ...
        try (Connection connection = Dbconfig.getConnection();
            ...
            System.err.println("Erreur lors de la recherche des tâches par catégorie : " + e.getMessage());
